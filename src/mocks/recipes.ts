        ...
        instructions: [
            {
                ...
                steps: [
                    {
                        text:
                            "In a bowl, combine @[boneless chicken thighs](chicken), @[plain yogurt](yogurt), @[ginger garlic paste](ginger_garlic), and @[masala spice mix](masala_spices) with a pinch of @[salt](salt).",
            ...
            },
            {
                ...
                steps: [
                    {
                        text:
                            "Heat @[cooking oil](oil) in a skillet over medium-high heat.",
                        timing: null,
                    },
                    {
                        text:
                            "Add the marinated @[boneless chicken thighs](chicken) and cook until lightly browned on all sides.",
            ...
            },
            {
                ...
                steps: [
                    {
                        text:
                            "Stir in @[tomato puree](tomato_puree) and let it simmer for about 5 minutes.",
                        timing: { min: 5, max: 5, units: "minutes" },
                    },
                    {
                        text:
                            "Reduce heat to low, then add @[heavy cream](cream).",
                        timing: null,
                    },
                    {
                        text:
                            "Season with @[salt](salt) if needed, and simmer until the chicken is fully cooked.",
        ...
        instructions: [
            {
                ...
                steps: [
                    {
                        text:
                            "In a bowl, mix @[chicken breast](chicken) with @[taco seasoning](taco_seasoning), @[lime juice](lime_juice), and a pinch of @[salt](salt).",
                        timing: null,
                    },
                    {
            ...
            },
            {
                ...
                steps: [
                    {
                        text:
                            "Heat @[vegetable oil](oil) in a pan over medium-high heat.",
                        timing: null,
                    },
                    {
                        text:
                            "Add @[chicken breast](chicken) and cook until browned and fully done, about 5-7 minutes.",
                        timing: { min: 5, max: 7, units: "minutes" },
                    },
                ],
            },
            {
                ...
                steps: [
                    {
                        text:
                            "Warm @[small flour tortillas](tortillas) in a microwave or on a skillet.",
                        timing: null,
                    },
                    {
                        text:
                            "Fill each tortilla with cooked @[chicken breast](chicken), @[shredded lettuce](lettuce), @[shredded cheese](cheese), and top with @[salsa](salsa).",
                        timing: null,
                    },
                ],
            },
        ...
        instructions: [
            {
                ...
                steps: [
                    {
                        text:
                            "Boil water in a large pot with a pinch of @[salt](salt).",
                        timing: null,
                    },
                    {
                        text:
                            "Add @[penne pasta](pasta) and cook according to package directions.",
                        timing: null,
                    },
                    {
                        text:
                            "During the last 2 minutes, add @[broccoli florets](broccoli) to the same pot.",
            ...
            },
            {
                ...
                steps: [
                    {
                        text:
                            "Meanwhile, heat @[olive oil](olive_oil) in a pan over medium heat.",
                        timing: null,
                    },
                    {
                        text:
                            "Season @[salmon fillet](salmon) with @[salt](salt) and @[black pepper](pepper).",
                        timing: null,
                    },
                    {
                        text:
            ...
            },
            {
                ...
                steps: [
                    {
                        text:
                            "Drain the pasta and @[broccoli florets](broccoli), then return them to the pot.",
                        timing: null,
                    },
                    {
                        text:
                            "Add @[salmon fillet](salmon) and @[pesto sauce](pesto). Toss gently to coat everything in the sauce.",
                        timing: null,
                    },
                    {
                        text:
                            "Adjust seasoning with @[salt](salt) and @[black pepper](pepper) if needed.",
                        timing: null,
                    },
                ],
            },
