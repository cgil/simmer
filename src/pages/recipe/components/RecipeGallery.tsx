...
// Define the ref handle type with exposed navigation methods
export interface RecipeGalleryHandle {
    goNext: () => void;
    goPrev: () => void;
    handleTouchStart: (e: React.TouchEvent<Element> | TouchEvent) => void;
    handleTouchEnd: (e: React.TouchEvent<Element> | TouchEvent) => void;
}

const RecipeGallery = forwardRef<RecipeGalleryHandle, RecipeGalleryProps>(
    (
        { images, heroHeight = { xs: 300, sm: 400, md: 500 }, onImageChange },
        ref
    ) => {
        ...
        }, [currentIndex, images, notifyParentOfChange]);
        ...
        const handleTouchStart = useCallback(
            (e: React.TouchEvent<Element> | TouchEvent) => {
                ...
                const touches =
                    'touches' in e ? e.touches : (e as TouchEvent).touches;
        ...
        // Expose the navigation methods to parent via ref
